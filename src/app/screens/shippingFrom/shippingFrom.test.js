...
import ShipingFrom from '.';

describe('<ShipingFrom />', () => {
  let store;
  let persistor;
  let container;
  ...
  it('should change default state to name of component on clicking the button', () => {
    ...
    expect(document.querySelector('.shipingfrom-container > p').innerHTML).toBe(
      'Default State: ShipingFrom',
    );
  });
