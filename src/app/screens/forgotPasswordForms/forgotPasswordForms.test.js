...
import ForgotPasswordForms from '.';

describe('<ForgotPasswordForms />', () => {
  let store;
  let persistor;
  let container;
  ...
  it('should change default state to name of component on clicking the button', () => {
    ...
    expect(
      document.querySelector('.forgotpasswordforms-container > p').innerHTML,
    ).toBe('Default State: ForgotPasswordForms');
  });
