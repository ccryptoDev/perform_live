...
import AgoraRecording from '.';

describe('<AgoraRecording />', () => {
  let store;
  let persistor;
  let container;
  ...
  it('should change default state to name of component on clicking the button', () => {
    ...
    expect(document.querySelector('.agorarecording-container > p').innerHTML).toBe(
      'Default State: AgoraRecording',
    );
  });
