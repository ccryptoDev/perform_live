/**
 *
 * Tests for PerformanceScheduler
 *
 */
...
import PerformanceScheduler from '.';
...
describe('<PerformanceScheduler />', () => {
  ...
  it('should change default state to name of component on clicking the button', () => {
    ...
    expect(
      document.querySelector('.performancescheduler-container > p').innerHTML,
    ).toBe('Default State: PerformanceScheduler');
  });
