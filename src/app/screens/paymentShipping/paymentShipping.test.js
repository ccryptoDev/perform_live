...
import PaymentShipping from '.';

describe('<PaymentShipping />', () => {
  let store;
  let persistor;
  let container;
  ...
  it('should change default state to name of component on clicking the button', () => {
    ...
    expect(document.querySelector('.paymentshipping-container > p').innerHTML).toBe(
      'Default State: PaymentShipping',
    );
  });
