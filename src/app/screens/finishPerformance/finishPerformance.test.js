...
import FinishPerformance from '.';

describe('<FinishPerformance />', () => {
  let store;
  let persistor;
  let container;
  ...
  it('should change default state to name of component on clicking the button', () => {
    ...
    expect(document.querySelector('.finishperformance-container > p').innerHTML).toBe(
      'Default State: FinishPerformance',
    );
  });
