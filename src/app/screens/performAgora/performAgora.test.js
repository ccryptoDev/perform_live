...
import PerformAgora from '.';

describe('<PerformAgora />', () => {
  let store;
  let persistor;
  let container;
  ...
  it('should change default state to name of component on clicking the button', () => {
    ...
    expect(
      document.querySelector('.performagora-container > p').innerHTML,
    ).toBe('Default State: PerformAgora');
  });
